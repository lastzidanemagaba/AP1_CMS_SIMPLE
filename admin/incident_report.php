        ...
        <div class="row mb-2">
          ...
          <!--div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              ...
              <li class="breadcrumb-item active">Report Insiden <?php //echo get_project();?></li>
            </ol>
          </div-->
        </div>
      </div><!-- /.container-fluid -->
                ...
                <table id="example1" class="table table-bordered table-hover">
				  ...
				  <?php
					if($awal == ""){
						...
						insiden_report.id ID, insiden_report.deskripsi DESKRIPSI, insiden_report.id_shift SHIFT, 
						insiden_report.image IMAGE, insiden_report.create_date CREATE_DATE, insiden_report.time WAKTU,
						...
						ORDER BY insiden_report.id DESC LIMIT 100");
					}else if($awal != ""){
						$result = mysqli_query($con,"SELECT 
						insiden_report.id ID, insiden_report.deskripsi DESKRIPSI, insiden_report.id_shift SHIFT, 
						insiden_report.image IMAGE, insiden_report.create_date CREATE_DATE, insiden_report.time WAKTU,
						...
						LEFT JOIN subarea_list on subarea_list.id = insiden_report.id_subarea
						LEFT JOIN user_list on user_list.id = insiden_report.create_by
						WHERE (DATE(insiden_report.create_date) BETWEEN '$awal' AND '$akhir')
						ORDER BY insiden_report.id DESC LIMIT 100");
					}
					...
					while($row = mysqli_fetch_array($result)){
						...
						$IMAGE = "../assets/upload/insiden/$row[IMAGE]";
						...
						if(session_level()!="0"){
							...
							<td align='center'>
								...
								<a href='incident_act?finding=".md5($row['ID'])."&status=".md5("hapus")."' class='btn btn-danger btn-small' onClick=\"return confirm('Do you want delete this data ?')\" >Delete</a>
								</b>
							</td>
						</tr>";
						}
...
<div id="modaledit<?php echo $row['ID']; ?>" class="modal fade">
	<div class="modal-dialog">
		<form action="incident_act" method="post" enctype="multipart/form-data">
			<div class="modal-content">
				<div class="modal-header">Incident Report Edit</div>
